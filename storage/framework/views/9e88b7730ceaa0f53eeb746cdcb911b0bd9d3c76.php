...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="upload-movie" method="post" <?php if(isset($post)): ?> action="<?php echo e(route('Panel.EditSerie',$post)); ?>" <?php else: ?>
                action="<?php echo e(route('Panel.AddSerie')); ?>" <?php endif; ?> enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="row series-date">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="serie_status" id="serie_status"
                                    value="<?php echo e($post->publish_status ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-6">
