        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style="padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;">{{$movies}}<sup style="font-size: 20px"></sup>
                        </h3>
        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style="padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;">{{$series}}<sup style="font-size: 20px"></sup>
                        </h3>
        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style="padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;">{{$users}}<sup style="font-size: 20px"></sup>
                        </h3>
        ...
        <div class="col-lg-3 col-sm-6 my-3">
            <a href="#">
                <div class="small-box" style=" padding: 20px;
                    ...
                    border-radius: 7px;">
                    <div class="inner">
                        <h3 style="color: white !important;">{{$blogs}}<sup style="font-size: 20px"></sup>
                        </h3>
